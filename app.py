...
def scanner_tab():
    ...
    if st.button("Generate Report"):
        ...
        companies = ["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "META", "NVDA", "NFLX", "CRM", "ORCL", "ADBE", "INTC", "AMD", "QCOM", "AVGO", "TXN", "MU", "AMAT", "LRCX", "KLAC", "MRVL", "ADI", "MCHP", "SWKS", "QRVO", "XLNX", "INTU", "PYPL", "SQ", "SHOP", "UBER", "LYFT", "ABNB", "DASH", "SNOW", "ZM", "OKTA", "DDOG", "NET", "FSLY", "TWLO", "ZS", "CRWD", "S", "WORK", "DOCU", "COUP", "SPLK", "NOW", "WDAY", "VEEV", "CZR", "MGM", "WYNN", "LVS", "PENN", "DKNG", "PLAY", "SIX", "FUN", "SEAS", "DIS", "CMCSA", "T", "VZ", "TMUS", "CHTR", "DISH", "SIRI", "FOXA", "FOX", "VIAC", "DISCA", "DISCB", "AMC", "CNK", "IMAX", "REGAL", "LGF.A", "LGF.B", "MSGS", "MSGN", "EDR", "ROKU", "FUBO", "GOGO", "SATS", "LBRDA", "LBRDK", "LILA", "LILAK", "BATRK", "BATRA", "GCI", "CABO", "CCOI", "COGN", "CORD", "WMG", "SPOT", "TME", "IQ", "BILI", "HUYA", "DOYU", "MOMO", "YY", "JOYY", "WB", "PARA", "NWSA", "NWS", "NYT", "GCI", "TEGN", "TGNA", "SBGI", "NXST", "GTN", "SSP", "EW", "EWS", "GRAY", "AMC", "REGAL", "CNK", "IMAX", "CINF", "IRDM", "VSAT", "GILT", "ECPG", "LUMN", "CTL", "FTR", "CENX", "WIN", "WINDW", "JCS", "SHEN", "USM", "CABO", "ATI", "ARNC", "AA", "ACH", "KALU", "CENX", "HCC", "CMC", "SXC", "GGB", "VALE", "FCX", "SCCO", "TECK", "BHP", "RIO", "GOLD", "NEM", "ABX", "AEM", "FNV", "WPM", "PAAS", "HL", "CDE", "EXK", "FSM", "AG", "SILV", "SLV", "GLD", "IAU", "GDXJ", "GDX", "NUGT", "DUST", "JNUG", "JDST", "XBI", "IBB", "ARKG", "ARKK", "ARKQ", "ARKW", "ARKF", "GILD", "AMGN", "BIIB", "CELG", "REGN", "VRTX", "ILMN", "MRNA", "BNTX", "PFE", "JNJ", "MRK", "ABT", "TMO", "DHR", "BDX", "SYK", "BSX", "MDT", "ISRG", "EW", "ZBH", "HOLX", "VAR", "DXCM", "ALGN", "IDXX", "IQV", "A", "LH", "DGX", "PKI", "MTD", "MASI", "TFX", "RMD", "TECH", "PEN", "NEOG", "OMCL", "IART", "CNMD", "TMDX", "QGEN", "CDNA", "EXAS", "VEEV", "TDOC", "HIMS", "AMWL", "ONEM", "ACCD", "TNDM", "DXCM", "SENS", "PODD", "NVST", "NTRA", "KRYS", "MA", "V", "AXP", "COF", "DFS", "SYF", "JPM", "BAC", "WFC", "C", "GS", "MS", "BLK", "SCHW", "SPGI", "MCO", "ICE", "CME", "NDAQ", "CBOE", "TW", "MKTX", "VIRT", "VIRTU", "KKR", "BX", "APO", "CG", "OWL", "ARES", "BAM", "BN", "RBLX", "EA", "ATVI", "TTWO", "ZNGA", "HUYA", "DOYU", "BILI", "TME", "IQ", "NTES", "WB", "GME", "PLTR", "COIN", "HOOD", "SOFI", "UPST", "AFRM", "LC", "ONDK", "OPFI", "PROG", "BBIG", "SPRT", "GREE", "IRNT", "OPAD", "TMC", "GRAB", "DIDI", "BABA", "JD", "PDD", "BIDU", "NIO", "XPEV", "LI", "LCID", "RIVN", "F", "GM", "GOEV", "NKLA", "RIDE", "WKHS", "HYLN", "SOLO", "AYRO", "IDEX", "BLNK", "CHPT", "EVGO", "PLUG", "FCEL", "BE", "BLDP", "HYSR", "SUNW", "RUN", "SPWR", "ENPH", "SEDG", "CSIQ", "JKS", "SOL", "NOVA", "FSLR", "DQ", "TSM", "UMC", "ASX", "HIMX", "OLED", "VUZI", "KOPN", "MVIS", "LAZR", "VLDR", "LIDR", "AEVA", "INVZ", "AEYE"]
